...
cp /usr/local/pge/GSFC/exec/AIRX3STM.005.history-no-2013-03 /usr/local/pge/GSFC/exec/AIRX3STM.005.history

# run example workflow
cd /usr/local/cmac/workflow/bin
./wmgr-client --url http://localhost:9200 --operation --sendEvent --eventName esgf --metaData --key data_node test-datanode.jpl.nasa.gov